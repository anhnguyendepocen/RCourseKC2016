...
1. Find the most parsimonius model that is a subset of the model fit above.
    a. Using either a likelihood ratio test, extra sums-of-squares test, or the $AICc$ criterion.
    1. Summarize (in words) the results of the most parsimonious model identified above.
\vspace{24pt}
1. [**Time Permitting**] Fit the typical VBGF seprately to both sexes.
